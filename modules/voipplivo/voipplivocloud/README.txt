...
Plivo Cloud (http://plivo.com/) is a cloud-based platform to build voice & SMS applications. It helps you build powerful telephony apps without having to worry about the telecom infrastructure.
...
4. Enter this number in the VoIP Drupal "default call configuration" form at admin/voip/call/settings .
